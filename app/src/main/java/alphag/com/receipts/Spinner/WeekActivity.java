...
public class WeekActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTotal = (TextView) findViewById(R.id.tv_week_total);

        mRootRef = FirebaseDatabase.getInstance().getReference();
        mUsersRef = mRootRef.child(FireBaseDataBaseUtils.getUsersKey());

        mReceiptsRV = (RecyclerView) findViewById(R.id.rv_week_activity);
        ...
        userReceiptRootRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mfinalReceipts = DateUtils.filter(tempFinalReceipts,7);
                ...
                Toast.makeText(WeekActivity.this, "User Data was Appended", Toast.LENGTH_SHORT).show();

                LinearLayoutManager layoutManager = new LinearLayoutManager(WeekActivity.this);
